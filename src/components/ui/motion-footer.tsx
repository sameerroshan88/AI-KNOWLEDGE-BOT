...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    ...
    <span>API Access</span> <span className="text-secondary/60">✦</span>
    <span>Secure & Private</span> <span className="text-primary/60">✦</span>
  </div>
);
    ...
    <>
      ...
      */}
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper z-20">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="#hero" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 max-w-6xl mx-auto w-full">
              <p className="text-muted-foreground text-[11px] md:text-xs order-2 md:order-1 text-center md:text-left max-w-xs md:max-w-sm leading-relaxed">
                © 2024 AI Knowledge Base Bot. All rights reserved.
              </p>
              <div className="hidden sm:flex items-center gap-2 order-3 md:order-3 ml-auto">
                <AnimatedSocialLinks
                  socials={[
                    ...
                    { name: 'YouTube', image: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/YouTube_Logo_2017.svg' },
                    { name: 'Facebook', image: 'https://upload.wikimedia.org/wikipedia/commons/0/05/Facebook_Logo_%282019%29.png' },
                  ] as Social[]}
                  className="px-2"
                />
